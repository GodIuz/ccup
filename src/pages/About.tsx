    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto space-y-16">
          {/* Hero Section */}
          <div className="text-center space-y-6" data-animate className="opacity-0 translate-y-8 transition-all duration-700 ease-out">
          ...
          {/* Values Section */}
          <div className="grid md:grid-cols-3 gap-8" data-animate className="opacity-0 translate-y-8 transition-all duration-700 ease-out">
          ...
          {/* Story Section */}
          <div className="space-y-6" data-animate className="opacity-0 translate-y-8 transition-all duration-700 ease-out">
