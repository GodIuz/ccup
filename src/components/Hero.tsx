  ...
  return <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative px-4 py-32">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <span className="inline-block px-4 py-2 bg-accent/80 text-accent-foreground rounded-full text-sm font-medium mb-4 transform hover:scale-105 transition-all duration-300 animate-fadeIn" style={{
          animationDelay: '200ms'
        }}>
            ✨ Transform Your Business Financial Future
          </span>
          
          <h1 className="text-5xl md:text-7xl font-bold leading-tight bg-gradient-to-r from-primary via-primary/90 to-accent-foreground bg-clip-text text-transparent transform hover:scale-[1.01] transition-transform duration-500 animate-fadeIn" style={{
          ...
          animationDelay: '800ms'
            ...
            <Button asChild size="lg" className="group w-full sm:w-auto bg-primary hover:bg-primary/90 transform hover:scale-105 transition-all duration-300">
              <Link to="/pricing">
                Start Free Trial
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-2" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="group w-full sm:w-auto hover:bg-accent/5 transform hover:scale-105 transition-all duration-300">
